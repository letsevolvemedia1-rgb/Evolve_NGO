...
import {
  InterventionsTabs,
  InterventionItem,
} from "@/components/sections/youth-welfare/InterventionsTabs";
    ...
    icon: (
      ...
      >
        <path
          strokeLinecap="round"
          strokeLinejoin="round"
          d="M11.42 15.17l-5.1-3.06a1.5 1.5 0 010-2.58l5.1-3.06a1.5 1.5 0 011.639.02l4.907 3.06a1.5 1.5 0 010 2.54l-4.907 3.06a1.5 1.5 0 01-1.639.02zM4.5 17.5l6.42-3.86a1.5 1.5 0 011.639.02L19.5 17.5"
        />
      </svg>
    ),
  },
...
const heroSlides = ["/SkillDev/Slider.png", "/SkillDev/Slider2.png"];
...
export default function SkillDevelopmentProgramPage() {
  ...
  return (
    <main className="w-full bg-white font-sans text-slate-800">
      ...
      <section className="relative w-full bg-slate-100 overflow-hidden group">
        ...
        {heroSlides.map((slide, index) => (
          ...
          >
            <img
              src={slide}
              alt={`Skill Development Slide ${index + 1}`}
        ...
        <div className="flex flex-col lg:flex-row items-center gap-12 lg:gap-20">
          <div className="w-full lg:w-2/5 flex justify-center shrink-0">
            <div className="relative w-full max-w-[320px] aspect-square">
              <img
                src="/SkillDev/Why.png"
                alt="Why Skill Development"
          ...
          <div className="w-full lg:w-3/5 text-justify">
            <p className="text-xs md:text-sm lg:text-base text-slate-700 leading-relaxed mb-4">
              In an ever-evolving world, education alone is not enough —
              today&apos;s youth need practical skills, digital competency,
              confidence, and exposure to real-world learning to succeed. Yet,
              millions of young people globally face barriers to quality skill
              development due to financial limitations, lack of training
              resources, minimal industry exposure, and limited access to
              professional mentorship.
            </p>
            <p className="text-xs md:text-sm lg:text-base text-slate-700 leading-relaxed mb-4">
              Without the right skills, brilliant and hardworking youth often
              struggle for employment, career direction, and economic
              independence — resulting in untapped potential and lost
              opportunities.
            </p>
            <p className="text-xs md:text-sm lg:text-base text-slate-700 leading-relaxed">
              Equipping young people with future-ready skills is key to enabling
              long-term empowerment, sustainable livelihoods, and inclusive
              social growth.
            </p>
          </div>
        </div>
      ...
      <InterventionsTabs items={skillInterventions} fullWidth={true} />
            ...
            <div className="w-full md:w-7/12">
              <ul className="space-y-3">
                {skillFocus.map((item, index) => (
                  ...
                  >
                    <span className="text-slate-800 mt-[3px] shrink-0 font-bold text-xs">
                      •
                    </span>
                    <span>{item}</span>
                  </li>
        ...
        <div className="container mx-auto px-4 md:px-8 lg:px-16 pl-6 pr-6">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4 md:gap-6 lg:gap-8 max-w-5xl mx-auto">
            {[
              ...
              <div
                key={i}
                className="aspect-square bg-[#fdefd1] rounded-sm overflow-hidden flex items-center justify-center shadow-sm"
              >
                <img
                  src={src}
                  alt={`Skill Development Glimpse ${i + 1}`}
                  className="w-full h-full object-cover"
                />
              </div>
            ))}
